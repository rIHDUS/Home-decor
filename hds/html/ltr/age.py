...
print('''
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form class="m-t-20" action="addage_backend.py" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
					            <div class="row"> 
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" name="age_group" id="age_group" type="text" placeholder="Enter Age (Like 1-2 year)" required>
                                    </div>
