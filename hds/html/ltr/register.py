    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(../../assets/images/img.jpg) no-repeat center center;">
            <div class="auth-box">
                <div>
                    <div class="logo">
                        <br><h2 class="font-medium m-b-20" style="text-align:center;color:green;"><b>Registration</b></h2>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" method="post" action="registerbackend.py" onsubmit="return validatePasswords()">
                                ...
                                <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <button class="btn btn-block btn-lg btn-info" type="submit" style="background-color: green;">Register</button>
                                    </div>
                                </div>
                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        Already have an account? <a href="login.py" class="text-info m-l-5"><b style="color: green;">Log In</b></a><br>
                                    </div>
                                </div>
                            </form>
                        </div>
