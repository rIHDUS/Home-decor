...
print(f'''
    ...
    <body>
        <div class="main-wrapper">
            <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(../../assets/images/img.jpg) no-repeat center center;">
                <div class="auth-box">
                    <div id="loginform">
                        <div class="logo">
                            <br><h2 class="font-medium m-b-20" style="text-align:center;color:green;"><b>Admin Login</b></h2><br><br>
                        </div>
                        <!-- Form -->
                        <div class="row">
                            <div class="col-12">
                                <form class="form-horizontal m-t-20" id="loginform" method="post" action="loginbackend.py">
                                    ...
                                    <div class="form-group text-center">
                                        <div class="col-xs-12 p-b-20">
                                            <button class="btn btn-block btn-lg btn-info" type="submit" style="background-color: green;">Log In</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="form-group m-b-0 m-t-10">
                                        <div class="col-sm-12 text-center"><br>
                                            Don't have an account? <a href="register.py" class="text-info m-l-5"><b style="color: green;">Sign Up</b></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
