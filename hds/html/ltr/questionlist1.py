...
for x in myresult:
    ...
    <div style="display: flex; justify-content: center; align-items: center;">
        ...
        <a href="question_delete.py?id={x['id']}"><button style="margin-right: 5px; padding: 5px 10px; display: inline-block;">delete</button>
        <a href="question_edit.py?id={x['id']}"><button style="padding: 5px 10px; display: inline-block;">Edit</button>
