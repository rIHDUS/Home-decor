...
<body>
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="index.html" style="background-color: green;">
                        <!-- Logo icon -->
                        <b class="logo-icon">
        ...
        <!-- ============================================================== -->
        <aside class="left-sidebar" style="background-color: green;">
            <!-- Sidebar scroll-->
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <!-- User Profile-->
                            <div class="user-profile d-flex no-block dropdown m-t-20" style="background-color: green;">
                        ...
                        <!-- User Profile-->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="dashboard.py" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard </span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Patient </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"><a href="patientlist.py" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Patient List </span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-calendar-plus"></i><span class="hide-menu">Age </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="age.py" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Add New Age group </span></a></li>
                                <li class="sidebar-item"><a href="agelist.py" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Ages </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-pencil-box-outline"></i><span class="hide-menu">Questions </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="question.py" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Add New Questions </span></a></li>
                                <li class="sidebar-item"><a href="questionlist1.py" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Question List </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-power-off"></i><span class="hide-menu">Logout </span></a></li> 
                    </ul>
                </nav>
