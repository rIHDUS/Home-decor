...
for x in myresult:
    tr_html+=f'''
        <tr>
            <td>
                <a href="age_edit.py?aid={x['aid']}"><button class="btn btn-success">EDIT</button></a>
                <a href="age_delete.py?aid={x['aid']}"><button class="btn btn-danger">DELETE</button></a>
            </td>
            <td>{x['aid']}</td>
            <td>{x['age_group']}</td>
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Age List</h4>
