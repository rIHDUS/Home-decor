...
for x in myresult:
    tr_html += f'''
        <tr>
            <td>
                <a href="question_edit.py?que_id={x['id']}"><button class="btn btn-success"><i class="fas fa-edit"></i></button></a>
                <a href="question_delete.py?que_id={x['id']}"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
            </td>
            <td>{x['id']}</td>
            <td>{x['pat_age']}</td>
            <td>{x['ques']}</td>
