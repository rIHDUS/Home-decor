...
for x in myresult:
    tr_html += f'''
        <tr>
            <td>
                <a href="user_edit.py?usr_id={x['id']}"><button class="btn btn-success"><i class="fas fa-edit"></i></button></a>
                <a href="user_delete.py?usr_id={x['id']}"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
            </td>
            <td>{x['id']}</td>
            <td>{x['name']}</td>
            <td>{x['email']}</td>
